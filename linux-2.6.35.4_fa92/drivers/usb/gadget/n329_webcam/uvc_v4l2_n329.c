...
uvc_v4l2_do_ioctl(struct file *file, unsigned int cmd, void *arg)
{
	...
	{	
		u32V4l2GadgetUserBufferUsed = *(unsigned int*) arg;
		return 0;
	}
	case VIDIOC_S_MEMORY_POOL_PADDR:
	{
		u32V4l2GadgetUserBufferPAddr = *(unsigned int*) arg;
		return 0;
	}
	case VIDIOC_S_USER_MEMORY_POOL_NUMBER:
	{
		u32V4l2GadgetUserBufferNum = *(unsigned int*) arg;
		return 0;
	}
	case VIDIOC_S_USER_MEMORY_POOL_OFFSET:
	{
		u32V4l2GadgetUserBufferOffset = *(unsigned int*) arg;
		return 0;
	}
