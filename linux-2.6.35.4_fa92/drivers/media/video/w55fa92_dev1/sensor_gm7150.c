...
#define GM7150_BRIGHT_CTL_DEV1			0x09
#define GM7150_CONTRAST_CTL_DEV1		0x0C
#define GM7150_SATURATION_CTL_DEV1		0x0A
static BOOL	
...
)
{
	...
	if(vin_priv->sensor_intf->u8SensorDevID != g_uOvDeviceID[0])
		return FALSE;
	if(bIsRead)
		*pi32Value = (DrvVideoIn_I2cReadOV(vin_priv->sensor_intf->u8SensorDevID, GM7150_BRIGHT_CTL_DEV1)&0xff);//GM7150
	else
		DrvVideoIn_I2cWriteOV(vin_priv->sensor_intf->u8SensorDevID, GM7150_BRIGHT_CTL_DEV1, *pi32Value);
...
)
{
	...
	if(vin_priv->sensor_intf->u8SensorDevID != g_uOvDeviceID[0])
		return FALSE;
	if(bIsRead)
		*pi32Value = (DrvVideoIn_I2cReadOV(vin_priv->sensor_intf->u8SensorDevID, GM7150_CONTRAST_CTL_DEV1)&0xff);//GM7150
	else
		DrvVideoIn_I2cWriteOV(vin_priv->sensor_intf->u8SensorDevID, GM7150_CONTRAST_CTL_DEV1, *pi32Value);
...
)
{
	...
	if(vin_priv->sensor_intf->u8SensorDevID != g_uOvDeviceID[0])
		return FALSE;
	if(bIsRead)
		*pi32Value = (DrvVideoIn_I2cReadOV(vin_priv->sensor_intf->u8SensorDevID, GM7150_SATURATION_CTL_DEV1)&0xff);//GM7150
	else
		DrvVideoIn_I2cWriteOV(vin_priv->sensor_intf->u8SensorDevID, GM7150_SATURATION_CTL_DEV1, *pi32Value);
