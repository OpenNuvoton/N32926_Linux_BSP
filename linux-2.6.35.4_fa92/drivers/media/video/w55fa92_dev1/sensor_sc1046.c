...
static struct HM_RegValue g_ssc1046_HD720[] = 
{
	//#include "SC1046/SC1024_HD720.dat"
#ifdef CONFIG_SC1046_TARGET_25FPS_DEV1	
	#include "SC1046/SC1046_HD720_PCLK_60MHz.dat"
#endif
#ifdef CONFIG_SC1046_TARGET_20FPS_DEV1
...
static struct HM_RegValue g_ssc1046_VGA[] = 
{
...
static struct HM_RegTable g_sc1046_InitTable[] =
{
	{g_ssc1046_VGA,_REG_TABLE_SIZE(g_ssc1046_VGA)},	
	{g_ssc1046_HD720,_REG_TABLE_SIZE(g_ssc1046_HD720)},
	{0,0}
};

static __u8 g_uOvDeviceID= 0x60;	// sc1046
...
//static int s_i32SensorClk = 24000;
...
static void HMSetResolution(int index)
{
	...
	uTableSize = g_sc1046_InitTable[index].uTableSize;
	psRegValue = g_sc1046_InitTable[index].sRegTable;
...
static void sc1046RegConfig(void)
{
  	__u32 i;
	__u16 uTableSize;
	__u8  uDeviceID;
	...
	uTableSize = g_sc1046_InitTable[REG_VALUE_VGA].uTableSize;
	psRegValue = g_sc1046_InitTable[REG_VALUE_VGA].sRegTable;
	uDeviceID = g_uOvDeviceID;
	...
	//csi_dev_set_iq_99141(uDeviceID);
...
static __s32 InitSensor(__u32 u32Sensor, void *priv)
{
	...
	vin_priv->pDevVin->SetDataFormatAndOrder(eVIDEOIN_IN_UYVY,//eVIDEOIN_IN_VYUY,//eVIDEOIN_IN_UYVY, 
									eVIDEOIN_IN_YUV422, 									
									eVIDEOIN_OUT_YUV422);			
...
{
  //auto_lux_det(csi_dev_set_iq_99141(g_uOvDeviceID));
...
/*================================================== V4L2 User Ctrl ================================================== */
#endif 
static NVT_SENSOR_T nvt_sensor_sc1046 = {
	...
	low_lux_detect:					NTLowLuxDetect, //NTLowLuxDetect,
...
{
	*sensor_intf = (NVT_SENSOR_T*)(&nvt_sensor_sc1046);
	return 0;
}
#endif 
