...
#elif defined  CONFIG_SENSOR_GC0303_DEV1
	static __u32 u32Sensor = GC_0303;
#elif defined  CONFIG_SENSOR_AVNET_DEV1
	static __u32 u32Sensor = AV_1000;
#elif defined  CONFIG_SENSOR_OV10633_DEV1
	static __u32 u32Sensor = OV_10633;	
#elif defined  CONFIG_SENSOR_SC1046_DEV1
...
static int videoin_close(struct file *file)
{
	...
	{//
		...
		do{
			...
			ntime = ntime+1;
			if(ntime>20)
				break;	/* time out, may be the sensor module have been removed (ESD test)*/
		}while(priv->pDevVin->GetOperationMode()==TRUE);
#endif
	}
#if defined(CONFIG_SENSOR_GM7150_DEV1) || defined(CONFIG_SENSOR_TW9900_DEV1) || defined(CONFIG_SENSOR_TVP5150_DEV1)	
