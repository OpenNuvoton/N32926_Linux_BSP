...
#ifndef __ASM_ARM_W55FA92_VIDEOIN_PRIV_H
#define __ASM_ARM_W55FA92_VIDEOIN_PRIV_H
...
typedef struct
{
	...
	unsigned int (*set_planar_position)(struct file *file, unsigned int cmd, void *arg);
...
typedef struct nvt_sensor_t{
	...
	void	(*sensor_suspend)(BOOL);
	void	(*sensor_reset)(BOOL);	
...
//#endif
	...
	INT32 	i32UserPacketStride;	//New create for dual sensor
	INT32	i32UserPlanarStride;	//New create for dual sensor H tile
	INT32	i32UserPlanarHeight;	//New create for dual sensor V tile
	INT32	i32planar_pos_x;		//New create for dual sensor
	INT32	i32planar_pos_y;		//New create for dual sensor
...
unsigned int vin_ioctl_get_capture_time(struct file *fiS_KERNEL_CONFIGle,unsigned int cmd,void *arg);
