...
__u32 w55fa92_JPEG_Power(__u32 u32Index, __u32 u32Exp)
{
	if(u32Exp==0)
		return 1;
	else
...
__s32 w55fa92_Jpeg_SetEncodeMode(
	__u8 u8SourceFormat,
	__u16 u16JpegFormat
)
{
...
__s32 w55fa92_Jpeg_SetDecodeMode(
...
void w55fa92_Jpeg_Trigger(void)
{
...
__s32 w55fa92_Jpeg_CalScalingFactor(
...
__s32 w55fa92_Jpeg_SetScalingFactor(
	__u8	u8Mode,			//Up / Down Scaling
...
void w55fa92_Jpeg_GetDecodedDimension(
...
void w55fa92_Jpeg_SetDimension(
...
void w55fa92_Jpeg_GetDimension(
...
void w55fa92_Jpeg_GetScalingFactor(
	__u8	u8Mode,				//Up / Down Scaling	
...
__s32 w55fa92_Jpeg_SetWindowDecode(	
