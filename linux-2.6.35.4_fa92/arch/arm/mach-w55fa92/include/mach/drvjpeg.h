...
__s32
w55fa92_Jpeg_SetEncodeMode(
	__u8 u8SourceFormat,
	__u16 u16JpegFormat
);

__s32
w55fa92_Jpeg_SetDecodeMode(
...
__s32
w55fa92_Jpeg_SetQTAB(
	__u8* puQTable0,
	__u8* puQTable1,
	__u8* puQTable2,
	__u8 u8num);

__u32 w55fa92_Jpeg_GetVersion(void);
