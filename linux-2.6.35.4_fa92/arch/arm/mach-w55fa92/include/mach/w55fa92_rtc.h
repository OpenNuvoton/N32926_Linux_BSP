/* linux/include/asm-arm/arch-w55fa92/w55fa92_rtc.h
 *
 ...
 * Changelog:
 *
 *   2006/08/26     vincen.zswan add this file for nuvoton w55fa95 evb.
 */


#ifndef _W55FA92_RTC_H
#define _W55FA92_RTC_H
...
#define RTC_RAIE_ON      _IO('p', 0x15)  /* Alarm int. enable on         */
#define RTC_RAIE_OFF     _IO('p', 0x16)  /* ... off                      */
#define RTC_SET_SW_STATUS     _IOW('p', 0x17, int)
#define RTC_GET_SW_STATUS     _IOR('p', 0x18, int *)
#define RTC_SET_RALARM     _IOW('p', 0x19, int)
#define RTC_SET_RWALARM     _IOW('p', 0x1A, int)
#define RTC_ACCESS_ENABLE    _IO('p', 0x1B)  /* Periodic int. enable on      */
#define RTC_ACCESS_DISABLE   _IO('p', 0x1C)  /* ... off                      */
#define RTC_GET_ACCESS_STATUS     _IOR('p', 0x1D, int *)
#define RTC_SET_SW_REG0_DATA   _IOW('p', 0x1E, int)
#define RTC_GET_SW_REG0_DATA   _IOR('p', 0x1F, int *)
#define RTC_SET_SW_REG1_DATA   _IOW('p', 0x20, int)
#define RTC_GET_SW_REG1_DATA   _IOR('p', 0x21, int *)
#define RTC_SET_ALARM_MASK   _IOW('p', 0x22, int)
#define RTC_GET_ALARM_MASK   _IOR('p', 0x23, int *)
...
#define RTC_ALARM_MASK_SECOND		0x00
#define RTC_ALARM_MASK_MINUTE		0x01
#define RTC_ALARM_MASK_HOUR		0x02
#define RTC_ALARM_MASK_DAY		0x04
#define RTC_ALARM_MASK_MONTH		0x08
#define RTC_ALARM_MASK_YEAR		0x10
#define RTC_ALARM_MASK_DAYOFWEEK	0x20
