...
int w55fa92_edma_setup_cst(int channel, E_DRVEDMA_COLOR_FORMAT eSrcFormat, E_DRVEDMA_COLOR_FORMAT eDestFormat);
int w55fa92_edma_clear_cst(int channel);
int w55fa92_edma_setup_single(int channel, unsigned int src_addr, unsigned int dest_addr, unsigned int dma_length);
int w55fa92_edma_setup_pages(int channel, struct page **pages, unsigned int nr_pages,
			unsigned int dest_addr, unsigned int dma_length);
int w55fa92_edma_setup_virtual(int channel, unsigned int src_addr, unsigned int dest_addr,
				unsigned int dma_length);
void w55fa92_edma_free_sg(int channel);
int w55fa92_edma_setup_handlers(int channel, int interrupt, void (*irq_handler) (void *), void *data);
