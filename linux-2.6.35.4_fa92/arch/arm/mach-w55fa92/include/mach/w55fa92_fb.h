...
#define IOCTL_FB_SCALE_ENABLE	_IOW('v', 90, unsigned int)	// set scaling enable
#define IOCTL_FB_SCALE_DISABLE	_IOW('v', 91, unsigned int)	// set scaling disable
