/* linux/arch/arm/mach-w55fa92/dmac.c
 *
...
#define DMA_BASE_ADDR		        W55FA92_VA_DMAC_BUF_BASE
#define W55FA92_DMACCSR				(0x400 + DMA_BASE_ADDR) 
#define W55FA92_DMACISR				(0x414 + DMA_BASE_ADDR)
